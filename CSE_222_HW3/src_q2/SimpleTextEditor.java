...
public abstract class SimpleTextEditor {
    ...
    public void add_with_iterator(int position,String nameWillBeAdded) throws IOException {
        ...
        ListIterator<Character> iterator = textFileReader.iterator();
    ...
    public int find_with_iterator(char [] groupOfCharacters) throws IOException {
        String groupOfChar = String.valueOf(groupOfCharacters);
        TextFileReader textFileReader = new TextFileReader(file.getPath());
        Iterator<Character> iterator = textFileReader.iterator();
        char value;
        int index = 0;
        while(iterator.hasNext()){
            int counter = 0;
            value = iterator.next();
            Iterator<Character> temp = iterator;
    ...
    public void replace_without_iterator(char before, char after){
